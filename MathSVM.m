...
Show[
ListPlot[X[[Flatten[sv]]],PlotStyle->{Hue[0.6],PointSize[0.015]}],ListPlot[Extract[X,Position[y,1]]],
ListPlot[Extract[X,Position[y,-1]],PlotStyle->{GrayLevel[0.6]}],
ContourPlot[{df==0,df==1,df==-1},Evaluate[x1range],Evaluate[x2range],ContourStyle->{Automatic,Dashing[{.01,.01}],Dashing[{.01,.01}]}],
RemainingOptions[{KernelFunction},opts],PlotRange->All]]


SVMDataPlot[X_?MatrixQ,y_,opts___]:=
Show[
ListPlot[Extract[X,Position[y,1]]],
ListPlot[Extract[X,Position[y,-1]],PlotStyle->{GrayLevel[0.6]}],PlotRange->All,opts]
